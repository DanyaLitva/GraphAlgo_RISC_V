...
rvv:
	$(MAKE) CMAKE_OPTIONS="-DCMAKE_TOOLCHAIN_FILE=../toolchains/riscv64-1p0-gcc.toolchain.cmake -DWITH_RVV=ON -DMCA_LMUL=$(MCA_LMUL) -DMSA_LMUL=$(MSA_LMUL)"

rvv-f16:
	$(MAKE) CMAKE_OPTIONS="-DCMAKE_TOOLCHAIN_FILE=../toolchains/riscv64-1p0-gcc-f16.toolchain.cmake -DWITH_RVV=ON -DMCA_LMUL=$(MCA_LMUL) -DMSA_LMUL=$(MSA_LMUL)"

rvv-native: clean
	$(MAKE) CMAKE_OPTIONS="-DWITH_RVV=ON -DMCA_LMUL=$(MCA_LMUL) -DMSA_LMUL=$(MSA_LMUL)"
